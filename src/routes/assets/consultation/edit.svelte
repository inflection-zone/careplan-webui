...
<div class=" flex justify-center mt-5 flex-col items-center ">
    <form class="w-full max-w-4xl bg-[#ECE4FC] rounded-lg mx-auto">
        ...
        <div class="flex items-center mb-4 mt-10 mx-16">
            ...
            <div class="w-2/3">CONSULTATION-CC-2</div>
        </div>
        <div class="flex items-center my-4 mx-16">
            ...
            <div class="w-2/3">
                <input
                    type="text"
                    required
                    placeholder="Enter consultation name here..."
                    value="Nutrition"
        ...
        <div class="flex items-center my-4 mx-16">
            ...
            <div class="w-2/3">
                <textarea
                    ...
                    placeholder="Enter consultation description here..."
        ...
        <div class="flex items-center my-4 mx-16">
            <div class="w-1/3">
                <!-- svelte-ignore a11y-label-has-associated-control -->
                <label class="lable-text"> ConsultationType </label>
            </div>
            <div class="w-2/3">
                <textarea
                    class="textarea textarea-info w-full"
                    placeholder="Enter consultationtype here..."
